...
namespace MoslemToolkit.Data
{
    public class FaceService
    {
        ...
        public async Task<(IList<DetectedFace> faces,Image img)> UploadAndDetectFaces(byte[] imageFileData)
        {
        ...
        public async Task<(IList<DetectedFace> faces, Image img)> DetectFacesFromUrl(string ImageUrl)
        {
            // The list of Face attributes to return.
            IList<FaceAttributeType?> faceAttributes =
                new FaceAttributeType?[]
        ...
        public Image DrawBoundingBox(Bitmap imageData, IList<DetectedFace> faces)
        {
            Image image = imageData;//Image.FromFile(imageFilePath);
